                    ...
                    while (!$tokenInserted && $tokenRetries < 5) {
                        try {
                            ...
                            if ($evStmt->execute()) {
                                ...
                                if (strpos($evStmt->error, 'Duplicate') !== false && $tokenRetries < 4) {
                                    $tokenRetries++;
                                    continue;
                                }
                                throw new Exception('Error creating verification token: ' . $evStmt->error);
...
<div class="lk-layout">
    ...
    <div class="lk-results">
        <div class="lk-results-head">
            <span class="lk-count" id="lk-count"><b><?= count($researchers) ?></b> <?= count($researchers) !== 1 ? 'researchers' : 'researcher' ?></span>
