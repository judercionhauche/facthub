...
$searchSessionKey = preg_replace('/[^a-f0-9]/', '', $_GET['s'] ?? ''); // Sanitize session key
...
<div class="panel modalish">
    <div class="head-row">
        ...
        <a class="ghost-btn" href="<?= $fromSearch && $searchSessionKey ? 'index.php?page=search&s=' . h($searchSessionKey) : 'index.php?page=researchers' ?>">
