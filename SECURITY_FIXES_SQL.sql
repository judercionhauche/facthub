...
ALTER TABLE password_resets ADD INDEX IF NOT EXISTS idx_used_at (used_at);
...
ALTER TABLE audit_log ADD INDEX IF NOT EXISTS idx_actor (actor_email);
ALTER TABLE audit_log ADD INDEX IF NOT EXISTS idx_action (action);
ALTER TABLE audit_log ADD INDEX IF NOT EXISTS idx_time (created_at);
ALTER TABLE audit_log ADD INDEX IF NOT EXISTS idx_email (target_email);
